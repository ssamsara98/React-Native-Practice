import { View, Image, Text, ScrollView, StyleSheet, useWindowDimensions, GestureResponderEvent } from 'react-native';
...
type GameOverScreenProps = {
  roundsNumber: number;
  userNumber: number;
  onStartNewGame?: ((event: GestureResponderEvent) => void) | null;
};
