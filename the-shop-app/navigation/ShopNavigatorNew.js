  ...
  return (
    ...
    >
      <ShopDrawerNavigator.Screen
        ...
        options={{
          drawerIcon: (props) => (
            <Ionicons name={Platform.OS === 'android' ? 'md-cart' : 'ios-cart'} size={20} color={props.color} />
          ),
        }}
      />
      <ShopDrawerNavigator.Screen
        ...
        options={{
          drawerIcon: (props) => (
            <Ionicons name={Platform.OS === 'android' ? 'md-list' : 'ios-list'} size={20} color={props.color} />
          ),
        }}
      />
      <ShopDrawerNavigator.Screen
        ...
        options={{
          drawerIcon: (props) => (
            <Ionicons name={Platform.OS === 'android' ? 'md-create' : 'ios-create'} size={20} color={props.color} />
          ),
        }}
      />
    </ShopDrawerNavigator.Navigator>
